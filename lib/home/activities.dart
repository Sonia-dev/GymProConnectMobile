...
import '../data/controllers/activity_find_by_name_controller.dart';
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){Get.to(Activity(),arguments: activity);},
                        child: Container(
                          height: 150,
                          child: Stack(
                            children: <Widget>[
                              ClipRRect(
                                ...
                                child: Image.network(
                                  ...
                                  errorBuilder: (context, error, stackTrace) {
                                    return SizedBox(child: Image.asset("assets/images/no_image.jpg"));
                                  },
