...
class GymProLayout extends StatefulWidget {
  const GymProLayout({super.key});

  @override
  State<GymProLayout> createState() => _GymProLayoutState();
}

class _GymProLayoutState extends State<GymProLayout> {
  var _currentPage = 0;
