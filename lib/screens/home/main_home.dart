      ...
      child: Scaffold(
        body: RefreshIndicator(
          ...
          onRefresh: () async {
            ...
            await Get.find<ActivitiesController>().getActivities();
            await Get.find<PacksController>().getPacks();
            await Get.find<TrainersController>().getTrainers();
          },
          child: GetBuilder<ProfilController>(builder: (controller) {
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return Padding(
                            ...
                            child: GestureDetector(
                              ...
                              child: buildCircleAvatar(
                                  imagePath: activity.image != null ? "http://192.168.1.199:8000/${activity.image.toString()}"
                                    : "assets/no_image.jpg",
                                ...
                                children: <Widget>[
                                  ClipRRect(
                                    ...
                                    child: pack.image != null
                                        ? Image.network("http://192.168.1.199:8000/${pack.image.toString()}",
