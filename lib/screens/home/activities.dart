                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            ...
                            borderSide: const BorderSide(width: 1, color: Color(0xFFf34e3a)),
                          ),
                ...
                child: Obx(() {
                  return controller.filteredActivityList.isEmpty
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      final activity = controller.filteredActivityList[index];
                      return Padding(
                        padding: EdgeInsets.symmetric(vertical: 10.0),
                        child: GestureDetector(
                          onTap: () {
                            Get.toNamed(RouteHelper.activitieById);
                            controller.getActivityByID(activity.id!);
                          },
                          child: Container(
                            height: 200,
                            child: Stack(
