          ...
          Flexible(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Home', style: GoogleFonts.poppins(fontSize: 12), ),
              ],
            ),
          ),
          Flexible(
            child: Column(
              ...
              children: [
                ...
                Text('Members', style: GoogleFonts.poppins(fontSize: 12),),
              ],
            ),
          ),
          Expanded(
          ...
          Flexible(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Trainers',style: GoogleFonts.poppins(fontSize: 12),),
              ],
            ),
          ),
          Flexible(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Profil',style: GoogleFonts.poppins(color: Color(0xFFf34e3a),fontSize: 12),),
              ],
            ),
          ),
        ],
